...
public class BgGraphBuilder {
    ...
    private double  end_time = (new Date().getTime() + (60000 * 10))/fuzz;
    private double  start_time = (new Date().getTime() - ((60000 * 60 * 24)))/fuzz;
    ...
    private Line maxShowLine() {
        List<PointValue> maxShowValues = new ArrayList<>();
    ...
    private Line minShowLine() {
        List<PointValue> minShowValues = new ArrayList<>();
    ...
    private Axis previewXAxis(){
        List<AxisValue> previewXaxisValues = new ArrayList<>();
        final java.text.DateFormat timeFormat = hourFormat();
        timeFormat.setTimeZone(TimeZone.getDefault());
